...
A channel can look efficient at its current spend level and still be a poor place for additional budget.
...
## Average performance vs marginal performance

This is one of the most important distinctions in budget allocation.

### Average CPA

Average CPA tells me:
...
I would evaluate additional investment across five areas.
...
This tells me how efficiently the channel is currently operating.
...
- Audience saturation
- Incremental customer volume

A channel can perform well but have very little room left to scale.
...
A €100 CPA for a high-value customer may be better than a €60 CPA for a low-value customer.
...
Reported conversion is not always incremental growth.
...
Imagine the current performance looks like:

| Area | Current spend | Current CPA | Marginal CPA | Growth potential |
|---|---:|---:|---:|---|
| Paid Search | €30K | €70 | €105 | Medium |
